function [U_new, center, obj_fcn] = stepfcm2window(data, U, cluster_n, expo,k)
...
a=0.85; 
N=k^2;
center_1 = mf*data(ceil(N/2)) + sum(mf*[data(1:floor(N/2)),data(ceil(N/2)+1:end)]*a/N,2);         % new center % vi(cl)
center_2 = (1+a)*mf; 
